...
class _ProfileSetupContentState extends State<_ProfileSetupContent> {
  ...
  String _uploadedPhotoPath = 'Simulated_Image_Path.jpg'; // Dummy photo tracker
  ...
  void _submitProfile() {
    if (_step2FormKey.currentState?.validate() ?? false) {
      final details = <String, dynamic>{
        ...
        'visual_profile': _uploadedPhotoPath,
      };
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: currentStep == 0
                        ? Form(
                            key: _step1FormKey,
                            child: _buildStep1Fields(role),
                          )
                        : Form(
                            key: _step2FormKey,
                            child: _buildStep2Fields(role),
                          ),
                  ),
                ),
  ...
  Widget _buildStep1Fields(PartnerType role) {
    switch (role) {
      case PartnerType.doctor:
        return Column(
        ...
        return Column(
          ...
          children: [
            ...
            _buildTextField(
              ...
              hint: 'City Hope Hospital',
              validator: (v) =>
                  Validators.validateRequired(v, 'Clinic/hospital name'),
            ),
          ],
        );
      case PartnerType.laboratory:
        ...
        return Column(
          ...
          children: [
            ...
            _buildTextField(
              controller: _nameController,
              label: 'Center Name',
              hint: 'Indopo Radiography Center',
            ...
            const SizedBox(height: 8),
            Text(
              'Select all imaging modalities your center operates:',
  ...
  Widget _buildStep2Fields(PartnerType role) {
